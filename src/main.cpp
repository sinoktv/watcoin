...
//        LogPrintf("pindexBest:%s\n",pindexBest->ToString());
//        LogPrintf("nBestHeight:%d\n",nBestHeight);
//        LogPrintf("GetTotalBlocksEstimate:%s\n",Checkpoints::GetTotalBlocksEstimate());
        return true;
    }
...
//    LogPrintf("GetTime:%d\n",GetTime());
//    LogPrintf("nLastUpdate:%d\n",nLastUpdate);
//    LogPrintf("pindexBest:%d\n",pindexBest->GetBlockTime());
